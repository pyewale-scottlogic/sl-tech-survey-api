...
namespace TechSurveyAPI.Controllers
{
    ...
    public class CompaniesController : ControllerBase
    {
        ...
        public CompaniesController(IRepositoryWrapper repository, IMapper mapper, ILoggerManager logger)
        {
        ...
        public async Task<IActionResult> Company()
        {
            try
            {
                _logger.LogInfo($"In Get Company");
            ...
            {
                _logger.LogError($"Something went wrong in the Get Company service method {ex}");
